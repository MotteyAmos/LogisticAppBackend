import { z } from "zod";
import {  addressDetailsSchema, contactDetails, emergencyInfoSchema, financialInfoSchema, passwordSchema } from "./general";


export const vendorProfileSchema = z.object({
    contactDetails: contactDetails,
    address: addressDetailsSchema.omit({nationalIdentification:true}),
